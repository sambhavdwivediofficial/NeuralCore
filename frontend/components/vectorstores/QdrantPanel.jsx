// components/vectorstores/QdrantPanel.jsx
...
import { getQdrantStatus, getVectorStoreCollections, rebuildVectorIndex } from '@/services/vectorstores';
import { toast } from '@/components/common/Toast';
import { getErrorMessage } from '@/lib/axios';
import { formatCompactNumber } from '@/lib/utils';

export function QdrantPanel({ storeId }) {
  ...
  if (!storeId) {
    return (
      <EmptyState
        icon={Database}
        title="No Qdrant store connected"
        description="Connect a Qdrant instance to view its status."
      />
    );
  }
    ...
    <div className="flex flex-col gap-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>HNSW indexes with scalar quantization configured</CardDescription>
        </CardHeader>
        <CardContent>
